...
หมายเหตุ
ผม commit ไปเกิน 30 ครั้งเยอะมากครับเเต่พอผมอัปโหลดเข้า git hub เเล้วดึงประวัติ commit ให้ขึ้นในเว็บบราวเซอร์ไม่ได้ครับ ผมไม่เเน่ใจว่าบัญชีมันไม่เชื่อมต่อบัญชีในเครื่องหรือยังไงครับ มันนับเเค่อัปโหลดเป็น 1 commit ผมจึงพิมพ์หมายเหตุชี้เเจงไว้นะครับ ขอบคุณครับ
